...
Original file is located at
    https://colab.research.google.com/drive/1_YFdhrfMMzizae4lLkTYz1KVsHxz1gas
"""
...
"""# Justificación para el uso de la normalización con (0.1307,) y (0.3081,):
En el conjunto MNIST, la media y desviación estándar de los valores de los píxeles fueron calculadas a partir de las imágenes del conjunto de entrenamiento.
La media (0.1307) y la desviación estándar (0.3081) se usan para normalizar las imágenes.
Esto asegura que las imágenes tengan una distribución de media 0 y desviación estándar 1.
La normalización ayuda a estabilizar el entrenamiento, evitando que valores extremos
dominen el proceso y permite que la red neuronal aprenda más eficientemente.
"""
